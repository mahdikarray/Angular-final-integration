...
export class UniversiteService {
  ...
  getUniversite() {
    return this.http.get<any[]>(`${this.baseUrl}/findAllU`);
  }

  ajouterUniversite(universiteData: any): Observable<any> {
    return this.http.post(`${this.baseUrl}/addUniversite`, universiteData);
  }

  DeleteUniversite(id: number): Observable<any> {

    return this.http.delete(`${this.baseUrl}/DeleteUniversite/` + id, { responseType: 'text' });
  }
